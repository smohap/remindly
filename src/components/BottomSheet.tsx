      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            aria-modal="true"
            aria-label={label}
            className="card-solid fixed inset-x-0 bottom-0 z-[61] mx-auto max-h-[85dvh] w-full max-w-2xl overflow-y-auto rounded-b-none rounded-t-[28px] border-b-0 px-5 pt-3 md:bottom-6 md:rounded-b-[28px] md:border-b"
