...
const audiences = [
  {
    ...
    premium: [
      ...
      'Unlimited lists, notes & bookmarks (plus shared lists)',
...
const personalPlans: Plan[] = [
  {
    ...
    cta: 'Start free',
    features: [
      'Core reminders & smart lists',
      'Personal alarm & quiet hours',
      'AI natural-language add',
