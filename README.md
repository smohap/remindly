...
2. In the SQL editor, run the schema then the seed:
   ...
   - `supabase/migrations/0014_workspace_access.sql`  *(per-member workspace access: none / read / write, set by group admins)*
