...
2. In the SQL editor, run the schema then the seed:
   ...
   - `supabase/migrations/0014_workspace_access.sql`  *(per-member workspace access — superseded by 0015)*
   - `supabase/migrations/0015_item_access.sql`  *(access set per list and per note: a default for members plus per-member overrides)*
   - `supabase/migrations/0013_admin_plan_read.sql`  *(Super Admins can see everyone's plan)*
